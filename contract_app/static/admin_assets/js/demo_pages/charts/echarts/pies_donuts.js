...
document.addEventListener("DOMContentLoaded", function () {
	...
	// var review = <?php echo "$reviewdcount"; ?>;
	// var bool = "<?php echo $bool ?>";
	// console.log(contracts_pending);
	// Charts configuration
	// var review  = $("#contreview").data("num",num);
	//console.log(review);
	// num = num + 1;
	// console.log(num);
	...
	if (pie_basic_element) {
		...
		pie_basic.setOption({
			...
			legend: {
				...
				top: "top",
				left: 0,
				data: ["New Contracts", "Reviewed", "Approved", "Due"],
				itemHeight: 8,
				itemWidth: 8,
			},
			...
			series: [
				{
					...
					data: [
						{ value: 2000, name: "New Contracts" },
						{ value: 22, name: "Reviewed" },
						{ value: 234, name: "Approved" },
						{ value: 13, name: "Due" },
					],
				},
			],

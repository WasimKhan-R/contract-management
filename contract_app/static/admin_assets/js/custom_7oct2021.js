...
$("#update_ltol_invoice").click(function(){
      ...
      var rdescription = $("#rdescriptions").val();
      var tamount = $("#totalamount").val();
      ...
      if(lawyer_name=='')
        ...
        data={
          ...
          $.post(BASE_URL+'admin/update_ltol_invoice/'+originalinvno,data,function(fb){
          console.log(fb);
          if(fb.match('1'))
            {
                swal('Success','Invoice updated Successfully','success') 
                setTimeout(function(){
                   location.href = BASE_URL+"admin/client_to_lawyer_all";
                },2000);
            }
            else 
            {
...
$("#update_ltoc_invoice").click(function(){
      ...
      if(customer_fname=='')
          ...
          $.post(BASE_URL+'admin/update_ltoc_invoice/'+originalinvno,data,function(fb){
          console.log(fb);
          if(fb.match('1'))
            {
                swal('Success','Invoice updated Successfully','success') 
...
$("#update_offline_po").click(function(){
  var description = $("#descriptions").val();
  var amount = $("#amount").val();
  var rdescriptions = $("#rdescriptions").val();
  var ramount = $("#ramount").val();
  ...
  var originalinvno = $("#originalinvno").val();
          if(description=='')
            ...
            swal('Warning','Please Enter totalamount','warning')
          else{
            data={
              'description':description,
              'amount':amount,
              'rdescriptions':rdescriptions,
              'ramount':ramount,
              'tamount':tamount,
              'originalinvno':originalinvno
            }
            $.post(BASE_URL+'admin/update_offline_po/'+originalinvno,data,function(fb){
              console.log(fb);
              if(fb.match('1'))
                {
                    swal('Success','Invoice updated Successfully','success') 
...
$("#update_handling_ltol_invoice").click(function(){
  var description = $("#descriptions").val();
  var amount = $("#amount").val();
  var taxableamount = $("#taxableamount").val();
  var cgst = $("#cgst").val();
  ...
  var originalinvno = $("#originalinvno").val();
          if(description=='')
            ...
            $.post(BASE_URL+'admin/update_handling_ltol_invoice/'+originalinvno,data,function(fb){
              console.log(fb);
              if(fb.match('1'))
                {
                    swal('Success','Invoice updated Successfully','success') 
...
$("#update_handling_ltoc_invoice").click(function(){
  var description = $("#descriptions").val();
  var amount = $("#amount").val();
  var tamount = $("#tamount").val();
  var originalinvno = $("#originalinvno").val();
          if(description=='')
            ...
            $.post(BASE_URL+'admin/update_handling_ltoc_invoice/'+originalinvno,data,function(fb){
              console.log(fb);
              if(fb.match('1'))
                {
                    swal('Success','Invoice updated Successfully','success') 
...
$("#ltoc_lawyer_invoice").click(function(){
  ...
  var lawyer_state = $("#lawyer_state").val();
  var lawyer_firm_name = $("#lawyer_firm_name").val();
  var lawyer_gstin = $("#lawyer_gstin").val();
  if(invoice_type=='')
    swal('Warning','Please select invoice type','warning');
  else if(lawyer_name=='')
    ...
    data={
            ...
            'lawyer_id':lawyer_id,
            'lawyer_name':lawyer_name,
            'lawyer_firm_name':lawyer_firm_name,
            'lawyer_gstin':lawyer_gstin,
            'lawyer_email':lawyer_email,
